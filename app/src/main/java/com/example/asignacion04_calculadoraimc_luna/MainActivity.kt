package com.example.asignacion04_calculadoraimc_luna
...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var peso: EditText = findViewById(R.id.weight) as EditText
        var altura: EditText = findViewById(R.id.height) as EditText
        var calcular: Button = findViewById(R.id.calcualte) as Button
